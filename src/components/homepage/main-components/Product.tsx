    ...
    <ProductWrapper>
      ...
      <div className="extensive-text">
        <div className="text">
          ...
          At <strong>DimensionLab</strong>, we are building tools for engineers and researchers to tame the physics of their projects in hours. Collectively, they make up a cohesive platform we call SIML.ai. <br/> <br/>
          Under the hood, SIML.ai consists of two parts - <strong>Model Engineer</strong> and <strong>Simulation Studio</strong>.
        </div>
      </div>
    </ProductWrapper>
  )
